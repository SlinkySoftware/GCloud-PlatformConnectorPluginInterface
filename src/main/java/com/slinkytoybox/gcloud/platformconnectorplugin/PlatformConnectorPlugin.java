...
/**
 * Platform Connector Plugin interface defining the functions to be implemented
 * for each plugin
 *
...
public interface PlatformConnectorPlugin extends ExtensionPoint {
     ...
     * a PluginResponse abstract object. The concrete implementation of this
     * method
     * should implement the various tasks for the extended classes of
     * PluginRequest/Response
     *
    ...
    /**
     * Gets the source code for the plugin for the AGPL licensing requirement
     * when copying the demo plugin
     *
     * @return Source Container object containing Jar file contents, whether
     * the plugin is AGPL licensed, and the source file name
     */
    public SourceContainer getSourceCode();

    /**
     * Checks if the source code for the plugin is available as required for
     * the AGPL licensing requirement when copying the demo plugin
     *
     * @return true if source code is available
     */
